                        ...
                        <div class="card-body d-flex d-sm-flex flex-column align-items-center align-items-sm-center mx-4">
                            <div class="row pt-4">
                                ...
                                <div class="col justify-content-sm-center content col-12 mt-4" id="content_login">
                                    <form class="text-center form_login" action="<?php echo URLROOT;?>/admins/login" method="post" style="width: 100%;">
                                        ...
                                        <div class="relative">
                                            <div class="fas fa-eye eye1"></div><input class="form-control form-control password1 mb-3" type="password" name="password" placeholder="密碼" style="font-size: 18px;">
                                            <?php echo empty($data['password_err'])? $data['password_err'] : ''?>
                                        </div><button class="btn btn-primary mb-4" type="sumit" style="font-size: 33px;background: #63686d;width: 100%;">登入</button>
                                    </form>
                                </div>
                            </div>
                        </div>
