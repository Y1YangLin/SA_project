        ...
        <div class="row">
            <div class="col-lg-11 col-xl-8 offset-lg-1 offset-xl-2 rubberBand animated">
                <div class="text-center intro">
                    <h1 class="text-center"><strong>問卷介面</strong></h1>
                </div>
                <div class="text">
                            ...
                            <table class="table table-hover table-bordered">
                                <thead class="bill-header cs">
                                    <tr>
                                        ...
                                        <th id="trs-hd-1" class="col-lg-1">Questionnaire_ID</th>
                                        <th id="trs-hd-3" class="col-lg-2">Manager_ID</th>
                                        <th id="trs-hd-4" class="col-lg-3">Content</th>
                                        <th id="trs-hd-5" class="col-lg-2">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
