...
<body>
    <section data-aos="fade-up" data-aos-duration="800" id="hero">
        ...
        <h1 class="text-uppercase fs-2 fw-bold text-center text-white LandingTitle" style="margin-bottom: 16px;margin-top: 261px;">你現在是大哥 666</h1>
        ...
        <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            ...
            <div class="collapse navbar-collapse" id="navcol-1" style="color: rgb(255,255,255);">
                <ul class="navbar-nav nav-right">
                    <li class="nav-item" style="margin-left: 4px;margin-right: -1px;"><a class="nav-link active link-dark" href="index.html" style="color: rgba(224,217,217,0.9);margin-left: 8px;margin-right: 5px;padding-right: 0px;padding-left: 0px;">首頁</a></li>
                ...
                <div class="dropdown show"><a class="dropdown-toggle link-dark d-xl-flex justify-content-xl-start align-items-xl-center" aria-expanded="true" data-bs-toggle="dropdown" href="#" style="color: rgba(224,217,217,0.9);">服務</a>
                    <div class="dropdown-menu show" data-bs-popper="none"><a class="dropdown-item" href="services.html">膚質分析</a><a class="dropdown-item" href="#">商品比價</a></div>
                </div>
                <div class="dropdown show" style="margin-left: 763px;"><a class="dropdown-toggle fs-4 link-dark" aria-expanded="true" data-bs-toggle="dropdown" href="#" style="padding-bottom: 0px;margin-bottom: -1px;padding-top: 0px;"><i class="fa fa-user-circle"></i>&nbsp;</a>
                    <div class="dropdown-menu dropdown-menu-end show" data-bs-popper="none"><a class="dropdown-item" href="#">更改會員資料</a><a class="dropdown-item" href="#">登出</a></div>
                </div>
            </div>
        </div>
    </nav>
