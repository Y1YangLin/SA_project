...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="login_assets/css/styles.min.css">
  ...
  <body>
                     ...
                     <div class="card-body d-flex flex-column align-items-center" style="padding-bottom: 42px;margin-bottom: 24px;margin-top: 16px;padding-top: 12px;height: 663.5px;">
                        ...
                        <div class="content">
                           <div id = "content_signup" style="display: none ;">
                              <form class="text-center form_signup" action="../include/signup.inc.php" name="signup-form" method="post" style="width: 376px;padding-left: 0px; ">
                              ...
                              <div id = "content_login">
                                 <form class="text-center form_login" action="../include/login.inc.php" name="signin-form" method="post"style="width: 376px;padding-left: 0px;">
      ...
      <script src="login_assets/bootstrap/js/bootstrap.min.js"></script><script src="login_assets/js/script.min.js"></script>
   </body>
</html>